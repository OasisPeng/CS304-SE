...
class EventControllerTest {
    ...
    void testSave() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/event/save")
...
//        assertThat(response.getContentAsString()).isEqualTo("expectedResponse");
    ...
    void testUpdate() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/event/update")
                        .content("content").contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
...
//        assertThat(response.getContentAsString()).isEqualTo("expectedResponse");
    ...
    void testDel() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/event/del")
                        .content("content").contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
...
//        assertThat(response.getContentAsString()).isEqualTo("expectedResponse");
    ...
    void testQueryByWeek() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/event/queryByWeek")
                        .param("week", "0")
                        .param("owner", "owner")
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
...
//        assertThat(response.getContentAsString()).isEqualTo("expectedResponse");
    ...
    void testQuery() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/event/query")
                        .param("date", "date")
                        .param("owner", "owner")
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
