...
public class CodeGenerator {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://120.77.79.53:3306/cs304?useUnicode=true&characterEncoding=utf-8&useSSL=false&severTimezone=GM%2B8", "hailong", "fnv7ZFe26h69r7VCwMj9")
...
//                            .enableSwagger()// 开启 swagger 模式
                ...
                .packageConfig(builder -> {
                    builder.parent("com.example.cs304") // 设置父包名
                            .entity("entity")
                            .mapper("mapper")
                            .service("service")
